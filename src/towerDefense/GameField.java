...
public class GameField {
    ...
    public towerdefense.GameMaps gameMaps;
    ...
    private towerdefense.GameStage stage;
    int pivok;
    public ArrayList<Enemy> enemiesList;
    public GameField(towerdefense.Level lv, towerdefense.Player player) {
        this.player=player;
        index=0;
        stageNumber=0;
        enemiesList= new ArrayList<Enemy>();
        level=lv;
        stage=new towerdefense.GameStage(lv);
        gameMaps= new towerdefense.GameMaps(this);
